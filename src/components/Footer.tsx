...
const Footer: Component<JSX.HTMLAttributes<HTMLElement>> = (props) => {
	return (
		<footer
			class='px-2 sm:px-4 bg-very-dark-blue text-white p-6'
			{...props}
		>
			<div class='flex items-center flex-col md:flex-row justify-between gap-4 mx-auto lg:max-w-5xl xl:max-w-7xl pb-4'>
				<nav class='flex flex-col md:flex-row items-center justify-between px-2 sm:px-4'>
					<ul class='flex flex-col md:flex-row items-center gap-4 sm:gap-8'>
						<li>
							<a href='/'>
								<svg
									width='148'
